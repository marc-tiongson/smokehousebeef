...
export const metadata: Metadata = {
  title: "Terms and Conditions | Smokehouse Pit Beef",
  description: "Terms and conditions for the use of the Smokehouse Pit Beef website.",
};
  ...
  return (
    <div className={`${styles.wrap} container`}>
      ...
      <div className={styles.body}>
        <p>Welcome to Smokehouse Pit Beef!</p>
        <p>
          These terms and conditions outline the rules and regulations for the use of Smokehouse
          Pit Beef&rsquo;s Website, located at smokehousepitbeef.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not
          continue to use Smokehouse Pit Beef if you do not agree to take all of the terms and
          conditions stated on this page.
        </p>
        <p>
          The following terminology applies to these Terms and Conditions, Privacy Statement and
          Disclaimer Notice and all Agreements: &ldquo;Client&rdquo;, &ldquo;You&rdquo; and
          &ldquo;Your&rdquo; refers to you, the person log on this website and compliant to the
          Company&rsquo;s terms and conditions. &ldquo;The Company&rdquo;, &ldquo;Ourselves&rdquo;,
          &ldquo;We&rdquo;, &ldquo;Our&rdquo; and &ldquo;Us&rdquo;, refers to our Company.
          &ldquo;Party&rdquo;, &ldquo;Parties&rdquo;, or &ldquo;Us&rdquo;, refers to both the
          ...
          appropriate manner for the express purpose of meeting the Client&rsquo;s needs in
          respect of provision of the Company&rsquo;s stated services, in accordance with and
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By accessing Smokehouse Pit Beef, you agreed to use cookies
          in agreement with the Smokehouse Pit Beef&rsquo;s Privacy Policy.
        </p>
        <p>
          Most interactive websites use cookies to let us retrieve the user&rsquo;s details for each
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Smokehouse Pit Beef and/or its licensors own the intellectual
          property rights for all material on Smokehouse Pit Beef. All intellectual property
          rights are reserved. You may access this from Smokehouse Pit Beef for your own personal
          use subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Smokehouse Pit Beef</li>
          <li>Sell, rent or sub-license material from Smokehouse Pit Beef</li>
          <li>Reproduce, duplicate or copy material from Smokehouse Pit Beef</li>
          <li>Redistribute content from Smokehouse Pit Beef</li>
        </ul>
        <p>
          This Agreement shall begin on the date hereof. Our Terms and Conditions were created with
          the help of the{" "}
          <a
            href="https://h-supertools.com/web/terms-and-conditions-generator/"
            target="_blank"
        ...
        <p>
          ...
          information in certain areas of the website. Smokehouse Pit Beef does not filter, edit,
          publish or review Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Smokehouse Pit Beef, its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions.
          To the extent permitted by applicable laws, Smokehouse Pit Beef shall not be liable for
          the Comments or for any liability, damages or expenses caused and/or suffered as a result
          of any use of and/or posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Smokehouse Pit Beef reserves the right to monitor all Comments and to remove any Comments
        ...
        <p>
          You hereby grant Smokehouse Pit Beef a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          services; and (c) fits within the context of the linking party&rsquo;s site.
        </p>
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Smokehouse Pit Beef; and (d) the
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to Smokehouse Pit Beef.
        ...
        <ul>
          ...
          <li>
            ...
            the context and format of content on the linking party&rsquo;s site.
          </li>
        </ul>
        <p>
          No use of Smokehouse Pit Beef&rsquo;s logo or other artwork will be allowed for linking absent
        ...
        <p>
          ...
          also reserve the right to amend these terms and conditions and its linking policy at any
